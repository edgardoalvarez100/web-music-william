...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
	...
	<div class="kt-grid kt-grid--ver kt-grid--root">
		<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v1" id="kt_login">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
				...
				<!--begin::Aside-->
				<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url(./assets_admin/media/bg/bg-5.jpg);">
					<div class="kt-grid__item">
						<a href="/" class="kt-login__logo">
							<img src="./assets_admin/media/logos/livepanel.svg">
						</a>
					</div>
						...
						<div class="kt-login__form">
							...
							<form class="kt-form" action="{{ route('password.update') }}"  method="POST">
								...
								<div class="form-group">
									<input class="form-control" type="email" placeholder="{{ __('E-Mail Address') }}" name="email" autocomplete="off" required="" value="{{ $email ?? old('email') }}" autofocus>
								</div>
								<div class="form-group">
									<input class="form-control" type="password" placeholder="{{ __('Password') }}" name="password" autocomplete="off" required="">
								</div>
								<div class="form-group">
									<input class="form-control" type="password" placeholder="{{ __('Confirm Password') }}" name="password_confirmation" autocomplete="off" required="">
								</div>
								...
								<div class="kt-login__actions">
									...
									<button id="kt_login_signin_submit" class="btn btn-primary btn-elevate kt-login__btn-primary">{{ __('Reset Password') }}
									</button>
								</div>
	...
	<!-- <script src="./assets_admin/js/demo1/pages/login/login-1.js" type="text/javascript"></script> -->
