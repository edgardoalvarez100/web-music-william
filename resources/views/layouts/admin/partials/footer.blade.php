...
<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-footer__copyright">
			{{ date('Y') }}&nbsp;&copy;&nbsp;<a href="https://livedesign.org" target="_blank" class="kt-link">Live Design Inc.</a>
		</div>
...
<script src="{{ asset('third_party/prayer/script-prayer.js') }}" type="text/javascript"></script>
<link rel="stylesheet" href="{{ asset('third_party/prayer/prayer.css') }}">

<!--end::Global Theme Bundle -->

<!--begin::Page Vendors(used by this page) -->
<script src="./assets_admin/vendors/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
<script src="//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM" type="text/javascript"></script>
<script src="./assets_admin/vendors/custom/gmaps/gmaps.js" type="text/javascript"></script>
