...
<div class="kt-portlet kt-portlet--mobile col-xl-8">
	...
	<form class="kt-form kt-form--label-right" method="POST" action="{{route('job.update',$job->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
		<div class="kt-portlet__body">
			...
			<div class="form-group row">
				...
				<div class="col-10">
                <input class="form-control" type="text"  id="title" name="title" required="" value="{{ old('title',$job->title)}}">
				</div>
            </div>
            ...
            <div class="form-group row">
				...
				<div class="col-10">
                <input class="form-control" type="text"  id="slug" name="slug" required="" value="{{ old('slug',$job->slug)}}">
				</div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4 col-sm-10 col-xs-10 col-10">
                    <select class="form-control kt-selectpicker"  name="type" id="type" >
                        ...
                        <option value="temporary" @if($job->type == "temporary") selected @endif>Temporary</option>
            ...
            <div class="form-group row">
				...
				<div class="col-10">
                <textarea class="form-control" type="text"  id="description" name="description"  rows="3">{{$job->description}}</textarea>
				</div>
			</div>
			...
			<div class="form-group row">
                ...
                <div class="col-lg-4 col-sm-10 col-xs-10 col-10">
                    <div class="input-group date">
                        <input class="form-control kt_datepicker_3" type="text"  id="publication_startdate" name="publication_startdate" required=""  autocomplete="off" value="{{ $job->publication_startdate->format('Y-m-d H:i')}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4 col-sm-10 col-xs-10 col-10">
                    <div class="input-group date">
                        <input class="form-control kt_datepicker_3" type="text"  id="publication_enddate" name="publication_enddate" required=""  autocomplete="off" value="{{ $job->publication_enddate->format('Y-m-d H:i')}}">
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <i class="la la-calendar"></i>
                            </span>
			...
			<div class="form-group row">
				...
				<div class="col-10">
					<input class="form-control" type="text"  id="location" name="location" required="" placeholder="ex. Chandler, AZ" value="{{ $job->location }}">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-10">
					<input class="form-control" type="email"  id="email_notification" name="email_notification" required="" placeholder="" value="{{ $job->email_notification }}">
				</div>
            </div>
			...
			<div class="form-group row">
                ...
                <div class="col-5">
                    @if(isset($job->image))
					<img src="{{url('storage/jobs/'.$job->image)}}"  id="image" class="mb-2 img-fluid" style="max-height: 350px;">
					@endif
            ...
            <div class="form-group row">
                ...
                <div class="col-5">
                    @if(isset($job->file))
                        <ul>
                            <li><a href="{{ url('storage/jobs/'.$job->file) }}" target="_blank">{{ $job->file }}</a></li>
                        </ul>
                        @endif
                    <div class="custom-file">
			...
			<div class="form-group row">
                ...
                <div class="col-10">
                    <span class="kt-switch kt-switch--icon">
                        <label>
                            <input type="checkbox" name="status" id="status" @if($job->status) checked @endif>
                            <span></span>
                        </label>
                    </span>
                </div>
