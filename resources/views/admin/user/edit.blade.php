...
<div class="kt-portlet kt-portlet--mobile">
	...
	<form class="kt-form kt-form--label-right" action="{{ route('user.update', $user->id)}}" method="POST">
		<div class="kt-portlet__body">
			...
			<div class="form-group row">
				...
				<div class="col-10">
					<input class="form-control" type="text"  id="example-text-input" name="email" value="{{ $user->email}}" >
				</div>
			</div>
