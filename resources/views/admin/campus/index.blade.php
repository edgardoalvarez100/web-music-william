		...
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
					...
					&nbsp;
					<a href="{{ route('campus.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
					...
					<td nowrap>
						<span class="dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<a class="dropdown-item" href="{{ route('campus.edit',$campu->id) }}">
									<i class="la la-edit"></i> Edit Details
								</a>
								
								<form action="{{ route('campus.delete',$campu->id) }}" method="POST">
									{{ method_field('DELETE') }}
									{{ csrf_field() }}
						...
						<a href="{{ route('campus.show',$campu->id) }}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
